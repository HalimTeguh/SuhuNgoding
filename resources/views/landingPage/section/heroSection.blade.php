    ...
    <div class="-mx-5 flex flex-wrap items-center">
        <div class="w-full px-5">
            <div class="scroll-revealed mx-auto max-w-[780px] text-center">
                <h1
                    ...
                    An Easy and Fast Programming Learning Platform
                </h1>

                <p class="mx-auto mb-9 max-w-[600px] text-base text-primary-color sm:text-lg sm:leading-normal">
                    Master the basics of programming in a fun and standardized way. Complete modules, automated
                    tests, and an objective scoring system are ready to support your learning!
                </p>
        ...
        <div class="w-full px-5">
            <div class="scroll-revealed relative z-10 mx-auto max-w-[845px]">
                <figure class="mt-16">
                    <img src="{{ asset('landingPage/assets/img/hero.png') }}" alt="Hero image"
                        class="mx-auto max-w-full rounded-t-xl rounded-tr-xl" />
                </figure>

                <div class="absolute -left-9 bottom-0 z-[-1]">
                    <img src="{{ asset('landingPage/assets/img/dots.svg') }}" alt

...
<div class="card px-sm-6 px-0">
    <div class="card-body">
        <!-- Logo -->
        <div class="app-brand demo my-2 justify-content-center">
            <a href="index.html" class="app-brand-link">
                <span class="app-brand-text demo menu-text fw-bold ms-2">
                    <svg width="182" height="82" viewBox="0 0 182 82" class="w-full fill-current"
        ...
        <p class="mb-6">Make your dreams come true!</p>

        <form class="mb-6" action="/register" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <label for="idNumber" class="form-label" id="idLabel">NIS</label>
                    <input type="number" class="form-control @error('id_number') is-invalid @enderror" id="idNumber"
                        name="id_number" placeholder="Enter your NIS" value="{{ old('id_number') }}" />
                    @error('id_number')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    document.getElementById('roleSelect').addEventListener('change', function () {
        ...
        idNumber.placeholder = 'Enter your NIP';
        idNumber.disabled = false;
        } else if (this.value === 'student') {
            idLabel.textContent = 'NIS';
            idNumber.placeholder = 'Enter your NIS';
            idNumber.disabled = false;
        } else if (this.value === 'admin') {
            idLabel.textContent = 'ID Number';
            idNumber.placeholder = 'Not required';
            idNumber.value = ''; // Mengosongkan input jika sebelumnya diisi
            idNumber.disabled = true; // Menonaktifkan input
        }
    });
</script>
@endsection
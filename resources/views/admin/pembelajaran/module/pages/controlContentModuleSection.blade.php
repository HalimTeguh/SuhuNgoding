<div class="card mb-6 control-module">
    <div class="card-body">
        <form id="contentControlForm" method="POST"
            action="{{ route('dashboard.module.control.update', ['id' => '__ID__']) }}">
            @csrf
            @method('PUT')
...
<script>
    ...
    function loadControlContent(moduleId, contentId) {
        ...
        const url = `/dashboard/admin/pembelajaran/module/${moduleId}/content/${contentId}/control`;
        ...
        fetch(url)
            ...
            form.action = "{{ route('dashboard.module.control.update', ['id' => '__ID__']) }}".replace('__ID__', contentId);

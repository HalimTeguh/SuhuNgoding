...
@include('admin.pembelajaran.gamification.gamiCreateModal')
@include('admin.pembelajaran.gamification.gamiEditModal')
@include('admin.pembelajaran.gamification.gamiDeleteModal')

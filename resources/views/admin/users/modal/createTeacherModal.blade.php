<!-- Modal -->
<div class="modal fade" id="createTeacher" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">Create New Data Teacher</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/dashboard/admin/users/teacher" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-6">
                            <label for="NIPCreate" class="form-label">NIP</label>
                            <input type="number" id="NIPCreate" name="NIPCreate"
                                class="form-control @error('NIPCreate') is-invalid @enderror" placeholder="Enter NIP"
                                value="{{ old('NIPCreate') }}" />
                            @error('NIPCreate')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror

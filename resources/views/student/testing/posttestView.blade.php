...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @elseif($canDoPosttest && is_null($scorePosttest))
            @if($classType === 'experiment' && $moduleRemaining > 0)
            <div class="alert alert-warning border border-warning shadow-sm text-dark">
                <h5 class="mb-2">Masih Ada Modul yang Belum Diselesaikan</h5>
                <p>Anda masih memiliki <strong>{{ $moduleRemaining }}</strong> modul yang belum diselesaikan. Harap pelajari
                    semua materi terlebih dahulu sebelum mengerjakan post-test.</p>
            </div>
            @else
                        ...
                        <div class="sticky-top" style="top: 100px;">
                            <div class="card shadow-sm border-0 mb-4">
                                ...
                                <div class="card-body text-center">
                                    <p class="text-muted small my-3">Jika sudah yakin, klik tombol di bawah untuk submit
                                        jawaban.</p>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="alert alert-success mt-3">
                    <strong>Selamat!</strong> Anda telah menyelesaikan post-test, Terima kasih telah menggunakan sistem
                    ini
                </div>
                @else

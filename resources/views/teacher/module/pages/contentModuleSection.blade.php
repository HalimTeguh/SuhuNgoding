<div class="card mb-6 content-module">
    <div class="card-body">
        <form id="contentForm" action="dashboard/teacher/pembelajaran/content/{content}/?tab=Content" method="post">
            @csrf
            @method('PUT')
...
<script>
    ...
    function loadContent(moduleId, contentId) {
        ...
        fetch(`/dashboard/teacher/pembelajaran/module/${moduleId}/content/${contentId}`)
            ...
            .then(data => {
                ...
                document.getElementById('contentForm').action = `/dashboard/teacher/pembelajaran/content/${data.id}`;

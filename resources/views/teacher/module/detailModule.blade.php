    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row fv-plugins-icon-container">
            <div class="col-md-12">
                ...
                @include('teacher.module.pages.basicModuleSection')
                @include('teacher.module.pages.contentModuleSection')
                @include('teacher.module.pages.quizModuleSection')
                @include('teacher.module.pages.controlContentModuleSection')
...
<script>
    ...
    function uploadImage(event) {
        ...
        $.ajax({
            url: '/dashboard/teacher/pembelajaran/module/{{ $module->id }}/uploadImage',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function confirmResetImage() {
        $.ajax({
            url: '/dashboard/teacher/pembelajaran/module/{{ $module->id }}/resetImage',
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                _method: 'PUT'

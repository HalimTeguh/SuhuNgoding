    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 order-0 order-md-1">
                ...
                {{-- Student List --}}
                @include('teacher.class.section.studentSection')

                {{-- Module List --}}
                @include('teacher.class.section.moduleSection')
...
@include('teacher.class.partials.deleteClassesModal')
@include('teacher.class.partials.editClassCanvas')
@include('teacher.class.partials.deleteImageConfirmationModal')

@include('teacher.class.partials.attachModule2ClassesModal')
@include('teacher.class.partials.detachModuleFromClassesModal')
@include('teacher.class.partials.editStudentCanvas')
@include('teacher.class.partials.createStudentModal')
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        document.querySelectorAll(`.edit-class-btn`).forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                // form.action = `dashboard/teacher/pembelajaran/class/${id}`;

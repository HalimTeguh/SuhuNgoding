                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="pretestMenu">
                                                <form action="{{ route('teacher.testing.start') }}" method="POST"
                                                ...
                                                <form action="{{ route('teacher.testing.reset') }}" method="POST">
                                                    @csrf
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="totalRevenue">
                                        <form action="{{ route('teacher.testing.divideClass') }}" method="POST">
                                            @csrf
                                        ...
                                        <button type="button" class="dropdown-item btn-levene-test"
                                            data-url="{{ route('teacher.testing.levenesTest', ['classId' => '__CLASS__', 'moduleId' => '__MODULE__']) }}">
                                            Uji Homogenitas (Levene's Test) Pretest
                                        </button>
                                        <button type="button" class="dropdown-item btn-paired-test"
                                            data-url="/dashboard/teacher/testing/setting/class/__CLASS__/module/__MODULE__/paired-test">
                                            Uji Paired Sample T-Test
                                        </button>
                                        <button type="button" class="dropdown-item btn-independent-test"
                                            data-url="/dashboard/teacher/testing/setting/class/__CLASS__/module/__MODULE__/independent-test">
                                            Uji Independent Sample T-Test
                                        </button>
                                        <button type="button" class="dropdown-item btn-export-summary"
                                            data-url-template="/dashboard/teacher/testing/setting/export-summary/__CLASS__/__MODULE__">
                                            Export Data ke Excel
                                        </button>
                                        <form action="{{ route('teacher.testing.resetClass') }}" method="POST">
                                            @csrf
...
@include('teacher.testing.partials.assignClassTestingModal')
@include('teacher.testing.partials.levenesPretestModal')
@include('teacher.testing.partials.pairedSampleTestModal')
@include('teacher.testing.partials.independentSampleTestModal')
@include('teacher.testing.partials.changeClassTypeModal')
...
<script>
    document.getElementById('classSelect').addEventListener('change', function () {
        ...
        if(selected) {
            ...
            fetch(`/dashboard/teacher/testing/setting/class/${classId}/module/${moduleId}/summary`)
                .then(res => res.json())
                .then(data => {
                    console.log(data);
                    // Update angka
    ...
    function setupIndependentTest() {
        ...
        runBtn.addEventListener('click', function () {
            ...
            const moduleId = runBtn.getAttribute('data-module');
            const postUrl = runBtn.getAttribute('data-url');
            const getUrl = `/dashboard/teacher/testing/setting/class/${classId}/module/${moduleId}/independent-test`;

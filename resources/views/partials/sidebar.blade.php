...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Pages -->
    <li
      class="menu-item {{ $activeMenu === 'admin' || $activeMenu === 'teacher' || $activeMenu === 'student'  ? 'active open' : '' }}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        <div class="text-truncate" data-i18n="Users">Users</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item {{ $activeMenu === 'admin' ? 'active' : '' }}">
          <a href="/dashboard/admin/users/admin" class="menu-link">
            <div class="text-truncate" data-i18n="Admin">Admin</div>
          </a>
        </li>
        <li class="menu-item {{ $activeMenu === 'teacher' ? 'active' : '' }}">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ $activeMenu === 'class' || $activeMenu === 'learderboard'  ? 'active open' : '' }}">
      ...
      <ul class="menu-sub">
        <li class="menu-item {{ $activeMenu === 'class' ? 'active' : '' }}">
          <a href="{{ route('dashboard.student.class') }}" class="menu-link">
